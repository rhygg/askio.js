...
var Choices = require('../workers/choices');
var ScreenManager = require('../helpers/manager');
  ...
  getQuestion() {
    ...
    if (this.opt.default != null && this.status !== 'answered') {
      ...
      if (this.opt.type === 'password') {
        message += Color.italic.dim('[hidden] ');
      } else {
        message += Color.dim('(' + this.opt.default + ') ');
      }
    }
