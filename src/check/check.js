...
var Base = require('../@main/interface/base');
var Choices = require('../@main/workers/choices');
var observe = require('../@main/helpers/actions');
var Paginator = require('../@main/helpers/paginator');

class CheckPrompt extends Base {
  ...
  render(error) {
    ...
    if (this.status === 'answered') {
      ...
      message += Color.cyan(this.selection.join(', '));
  ...
  getCheckboxFigure(checked) {
    ...
    return checked ? Color.green(figures.radioOn) : figures.radioOff;
  ...
  renderChoices(choices, pointer) {
    ...
    choices.forEach(function(choice, index) {
      ...
      if (index - separatorOffset === pointer) {
        ...
        output += Color.cyan(figures.pointer);
        output += self.getCheckboxFigure(choice.checked) + ' ';
        output += self.opt.highlight ? Color.gray(choice.name) : choice.name;
